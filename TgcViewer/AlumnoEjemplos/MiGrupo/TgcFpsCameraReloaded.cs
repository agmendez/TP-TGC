...
namespace TgcViewer.Utils.Input
{
    ...
    /// </summary>
    public class TgcFpsCameraReloaded : TgcCamera
    {
        //Constantes de movimiento
        const float DEFAULT_ROTATION_SPEED = 2f;
        const float DEFAULT_MOVEMENT_SPEED = 10f;
        ...
        readonly Vector3 CAMERA_ACCELERATION = new Vector3(40f, 40f, 40f);
        ...
        public void updateCamera()
        {
            ...
            if (d3dInput.keyDown(Key.L) && System.DateTime.Now.TimeOfDay.TotalMilliseconds - lastTime > 500)
            {
                lastTime = System.DateTime.Now.TimeOfDay.TotalMilliseconds;
                isLocked=!isLocked;
                if (isLocked){
                    Cursor.Hide();
                }else {
            ...
            //Solo rotar si se la camara esta locked
            if (isLocked)
            {
